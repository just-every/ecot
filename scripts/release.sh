...
# Release script for @just-every/mech
...
echo -e "1. Go to https://github.com/just-every/task/releases/new"
...
echo -e "1. Go to https://github.com/just-every/task/actions/workflows/publish.yml"
